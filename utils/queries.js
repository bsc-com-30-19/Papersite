...
const addStudent =
  'INSERT INTO "USERAUTH" (username, email, password) VALUES($1, $2, $3) RETURNING *';
...
//file queries
const addFile =
  'INSERT INTO "FILES" (user_id, file_name, file_path, file_size, course) VALUES($1, $2, $3, $4, $5) RETURNING *';
